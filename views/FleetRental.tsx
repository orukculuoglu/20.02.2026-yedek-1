...
import { deriveFleetNormalizationReadModelFromFleetRental } from '../src/modules/fleet-connector/fleet-rental-adapter';
...
export default function FleetRental() {
  ...
  const renderOperationCenter = () => (
    <div className="space-y-6">
      ...
      {(() => {
        const fleetConnectorReadModel = deriveFleetNormalizationReadModelFromFleetRental({
          vehicles,
          contracts,
        });
        return (
