...
export const exampleServiceMaintenanceFeed: DataEngineFeedEnvelope = {
  ...
  sourceType: 'SERVICE' as DataSourceType,
...
export const exampleInsuranceClaimFeed: DataEngineFeedEnvelope = {
  ...
  sourceType: 'INSURANCE' as DataSourceType,
...
export const exampleTelematicsDiagnosticFeed: DataEngineFeedEnvelope = {
  ...
  identityId: 'anon_a7f9e2c3d8b1f4a6c9e2d5f8a1b4c7e0', // Same vehicle
  sourceType: 'TELEMATICS' as DataSourceType,
...
// ═══════════════════════════════════════════════════════════════════════════════
// EXAMPLE 4: DATA ENGINE ENTITY (POST-INGESTION)
// ═══════════════════════════════════════════════════════════════════════════════
 ...
 * The payload may be raw (pre-normalization) or normalized.
 *
 * This entity represents the same maintenance feed as Example 1,
 * but structured as an internal entity.
 *
 * entityId: Deterministically derived from identityId + entityType + payload
 */
export const exampleMaintenanceEntity: DataEngineEntity = {
  ...
  payload: {
    // Payload structure matches the feed above
    // In Phase 1, payload is typically raw from feed
